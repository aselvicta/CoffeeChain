...
export const translations = {
  en: {
    ...
    // OTP Verification
    otpVerification: 'Enter verification code',
    enterOtp: 'Enter verification code',
    otpSentTo: 'We\'ve sent a code to',
    verifyAndDistribute: 'Verify & complete',
    verifyCode: 'Verify',
  ...
  sw: {
    ...
    // OTP Verification
    otpVerification: 'Weka nambari ya uthibitisho',
    enterOtp: 'Weka nambari ya uthibitisho',
    otpSentTo: 'Tumetuma nambari kwenda',
    verifyAndDistribute: 'Hakiki na kamilisha',
    verifyCode: 'Hakiki',
    resendOtp: 'Tuma tena',
