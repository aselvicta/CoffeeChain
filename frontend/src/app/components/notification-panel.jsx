  ...
  return (
    <div className="fixed inset-0 z-40">
      <button
        ...
        onClick={onClose}
        className="absolute inset-0 cursor-default bg-gray-500/20"
      />
      <div className="absolute right-0 top-0 flex h-full w-full max-w-md flex-col border-l border-gray-200 bg-white shadow-lg">
        <div className="border-b border-gray-200 bg-white px-5 py-4">
          <div className="flex items-start justify-between gap-3">
            <div>
              <div className="mb-2 inline-flex items-center gap-2 rounded-lg bg-emerald-50 px-2.5 py-1 text-xs font-medium text-emerald-800">
                <Bell className="h-3.5 w-3.5" />
                Notifications
              </div>
              <h3 className="text-lg font-semibold text-gray-900">Activity feed</h3>
              <p className="text-sm text-gray-600">Dispatch updates, receipts, and delivery confirmations.</p>
            </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            ...
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-3">
              <p className="text-xs font-medium uppercase tracking-wide text-gray-500">Urgent</p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className={`rounded-lg p-2.5 ${notification.badgeTone}`}>
